package com.wanhe.zhongliang.https;
...
import com.wanhe.zhongliang.base.Constant;
...
public class GlideConfigModule implements GlideModule {
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        ...
        builder.setDiskCache(new InternalCacheDiskCacheFactory(context, "glide_cache", Constant.MAX_CACHE_DISK_SIZE));
        //指定内存缓存大小
